...
$sql = "SELECT orders.*, user.email
  FROM orders
  INNER JOIN user ON orders.uid = user.id
  WHERE $uSQL orders.isValid = 1
  LIMIT $pageStart, $perPage";
$sqlAll = "SELECT * FROM orders WHERE $uSQL `isValid` = 1";
try {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-3">
      <h1>購買記錄<span class="badge text-bg-warning fs-6 align-middle ms-1">清單</span></h1>

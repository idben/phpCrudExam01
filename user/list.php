...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-3">
      <h1>使用者清單<span class="badge text-bg-warning fs-6 align-middle ms-1">清單</span></h1>
      <div class="d-flex mb-2">
        <a class="btn btn-info btn-sm ms-auto" href="./add.php">增加使用者</a>
      </div>
      <?php if($error !== ""): ?>
      ...
      <?php else:?>
        <div class="user data head bg-primary p-1 text-white">
          ...
          <div class="level text-center">等級</div>
        ...
        <?php foreach($rows as $index => $row): ?>
          <div class="user data">
            ...
            <div class="level text-center"><?=$row["level"]?></div>
